...
def get_args():
	...
	parser.add_argument("-p", "--plots", help="saves plots to file named this...", required=True) 
...
with open(file, "r") as fh:
	...
	print("N50 of Assembly:", k_mer_length[LN])
...
x = Contig Length
y = Number of Contig Bins
plt.plot(x, y, "o") 

plt.title("Contig Length vs. Number of Contig Bins)

plt.xlabel("contig lengths")
plt.ylabel("number of contig bins")